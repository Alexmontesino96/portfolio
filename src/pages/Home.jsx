    ...
    <>
      <div className="px-4 sm:px-10 md:px-20 lg:px-40 flex flex-1 justify-center py-6 sm:py-10">
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
          <div className="flex p-4 sm:p-6 @container mb-6 sm:mb-8 md:mb-14" id="about">
            <div className="flex w-full flex-col gap-4 sm:gap-6 @[520px]:flex-row @[520px]:justify-between @[520px]:items-center">
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center">
                <div
                  ref={profileRef}
                  className="min-h-40 w-40 sm:min-h-48 sm:w-48 rounded-full overflow-hidden shadow-lg hover:scale-105 hover:shadow-[0_0_15px_rgba(var(--violet-9-rgb),0.4)] transition-all duration-300 cursor-pointer flex-shrink-0 mb-2 sm:mb-0 border-2 border-transparent"
                  style={{
                ...
                <div className="flex flex-col justify-center text-center sm:text-left my-auto sm:ml-8">
                  <p className="text-white text-[26px] sm:text-[28px] font-bold leading-tight tracking-[-0.015em] mb-1">Alex Montesino</p>
                  <p className="text-[#9dabb8] text-lg sm:text-xl font-normal leading-normal mb-3">Backend Developer | API Specialist</p>
                  <p className="text-[--violet-9] text-sm font-medium">&gt; Transforming ideas into scalable solutions</p>
                </div>
              </div>
              <div className="flex items-center justify-center sm:flex-col gap-3 mt-2 sm:mt-0">
                <a 
                  href="https://www.linkedin.com/in/alex-montesino-03797b1b0/" 
                  target="_blank"
                  className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 sm:px-6 bg-gradient-to-b from-[--violet-9] to-[--violet-9] hover:to-[--violet-10] text-white text-sm font-bold leading-normal tracking-[0.015em] w-full max-w-[120px] sm:max-w-[200px] transition-all border-t border-[rgba(255,255,255,0.21)]"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 sm:px-6 bg-black text-white text-sm font-bold leading-normal tracking-[0.015em] w-full max-w-[120px] sm:max-w-[200px] hover:bg-[#333333] transition-colors border border-white/30"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
