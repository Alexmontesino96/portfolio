    ...
    <>
      <div className="px-4 sm:px-10 md:px-20 lg:px-40 flex flex-1 justify-center">
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
          <div className="flex min-h-[90vh] items-center p-4 sm:p-6 @container mb-6 sm:mb-8 md:mb-14" id="about">
            <div className="flex w-full flex-col gap-6 @[520px]:flex-row @[520px]:justify-between @[520px]:items-center">
              <div className="flex flex-col sm:flex-row gap-6 items-center">
                <div
                  ref={profileRef}
                  className="min-h-[180px] w-[180px] sm:min-h-48 sm:w-48 rounded-full overflow-hidden shadow-lg hover:scale-105 hover:shadow-[0_0_15px_rgba(var(--violet-9-rgb),0.4)] transition-all duration-300 cursor-pointer flex-shrink-0 mb-4 sm:mb-0 border-2 border-transparent"
                  style={{
                ...
                <div className="flex flex-col justify-center text-center sm:text-left my-auto sm:ml-8">
                  <p className="text-white text-[30px] sm:text-[32px] font-bold leading-tight tracking-[-0.015em] mb-2">Alex Montesino</p>
                  <p className="text-[#9dabb8] text-xl sm:text-2xl font-normal leading-normal mb-4">Backend Developer | API Specialist</p>
                  <p className="text-[--violet-9] text-lg font-medium mb-6">&gt; Transforming ideas into scalable solutions</p>
                </div>
              </div>
              <div className="flex flex-row items-center justify-center sm:flex-col gap-4 mt-4 sm:mt-0">
                <a 
                  href="https://www.linkedin.com/in/alex-montesino-03797b1b0/" 
                  target="_blank"
                  className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-5 sm:px-6 bg-gradient-to-b from-[--violet-9] to-[--violet-9] hover:to-[--violet-10] text-white text-base font-bold leading-normal tracking-[0.015em] w-full max-w-[150px] sm:max-w-[200px] transition-all border-t border-[rgba(255,255,255,0.21)]"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-5 sm:px-6 bg-black text-white text-base font-bold leading-normal tracking-[0.015em] w-full max-w-[150px] sm:max-w-[200px] hover:bg-[#333333] transition-colors border border-white/30"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
          ...
          <h2 className="text-white text-[32px] font-bold leading-tight tracking-[-0.015em] px-6 pb-6 pt-4 md:pt-10 border-b border-[#293038] mb-8" id="work">Featured Projects</h2>
