        ...
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
          ...
          <div className="flex flex-col items-center justify-center px-6 py-12 bg-[#161B22] rounded-xl mb-16 border border-[#293038]" id="contact">
            ...
            <div className="flex gap-4">
              ...
              <a href="mailto:alex.montesino@example.com" className="flex items-center justify-center rounded-xl h-12 px-6 bg-[#3B82F6] text-white font-medium transition-colors hover:bg-[#2563EB]">
                <span>Contact</span>
              </a>
            </div>
          </div>
