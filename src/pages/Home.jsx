    ...
    <>
      <div className="px-10 md:px-20 lg:px-40 flex flex-1 justify-center py-10">
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
          <div className="flex p-6 @container mb-8 md:mb-14" id="about">
            <div className="flex w-full flex-col gap-6 @[520px]:flex-row @[520px]:justify-between @[520px]:items-center">
              ...
              <div className="flex flex-col items-center">
                <a 
                  ...
                  target="_blank"
                  className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-6 bg-[#3B82F6] text-white text-sm font-bold leading-normal tracking-[0.015em] w-full max-w-[200px] hover:bg-[#2563EB] transition-colors sm:mt-0 mb-3"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-6 bg-black text-white text-sm font-bold leading-normal tracking-[0.015em] w-full max-w-[200px] hover:bg-[#333333] transition-colors sm:mt-0 border border-white/30"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
          ...
          <div className="flex flex-col items-center justify-center px-6 py-12 bg-[#161B22] rounded-xl mb-16 border border-[#293038]" id="contact">
            ...
            <div className="flex gap-4 mb-4">
              ...
              <Link to="/projects" className="flex items-center justify-center rounded-xl h-12 px-6 bg-gradient-to-b from-[--violet-9] to-[--violet-9] hover:to-[--violet-10] text-white font-medium transition-all border-t border-[rgba(255,255,255,0.21)]">
                Ver proyectos
              </Link>
            </div>
            <a href="mailto:alex.montesino@example.com" className="flex items-center justify-center rounded-xl h-12 px-6 bg-gradient-to-b from-[--violet-9] to-[--violet-9] hover:to-[--violet-10] text-white font-medium transition-all border-t border-[rgba(255,255,255,0.21)]">
              Contactar
            </a>
          </div>
        </div>
