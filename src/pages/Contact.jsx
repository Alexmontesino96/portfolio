...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://formspree.io/f/mvgkroro', {
        method: 'POST',
        headers: {
              ...
              <div className="p-6">
                ...
                <div className={`${isDarkMode ? 'text-[#9dabb8]' : 'text-[#666]'} space-y-4`}>
                  <div className="flex items-start gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" width="24" height="24" className="flex-shrink-0 mt-1 text-[--violet-9]">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        className="text-sm hover:text-[--violet-9] transition-colors"
                      >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href="tel:+17866130320" className="text-sm hover:text-[--violet-9] transition-colors">
                        786-613-0320
                      </a>
                    </div>
                  </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex gap-4">
                    <a 
                      ...
                      target="_blank" 
                      className={`${isDarkMode ? 'bg-[#0D1117]' : 'bg-[#e0e0e0]'} w-10 h-10 rounded-full flex items-center justify-center ${isDarkMode ? 'text-white' : 'text-[#111418]'} hover:text-[--violet-9] transition-colors`}
                    >
