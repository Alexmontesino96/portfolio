      ...
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
              ...
              <ul className="space-y-2">
                <li>
                  <a 
                    ...
                    className={`flex items-center gap-2 ${isDarkMode ? 'text-[#9dabb8] hover:text-[#3B82F6]' : 'text-[#666] hover:text-[#3B82F6]'} transition-colors`}
                  >
          ...
          <div className="md:col-span-2">
            <div className={`${isDarkMode ? 'text-[#9dabb8]' : 'text-[#666]'} space-y-4`}>
              ...
              <div className={`${isDarkMode ? 'bg-[#161B22] border border-[#293038]' : 'bg-[#f0f0f0] border border-[#e0e0e0]'} rounded-xl p-4 mb-4`}>
                ...
                <p className="text-sm text-[#3B82F6]">TechSolutions Inc. · 2020 - Presente</p>
              ...
              <div className={`${isDarkMode ? 'bg-[#161B22] border border-[#293038]' : 'bg-[#f0f0f0] border border-[#e0e0e0]'} rounded-xl p-4 mb-4`}>
                ...
                <p className="text-sm text-[#3B82F6]">DataCorp · 2018 - 2020</p>
                <ul className={`${isDarkMode ? 'text-[#9dabb8]' : 'text-[#666]'} mt-2 list-disc pl-5 text-sm space-y-1`}>
              ...
              <div className={`${isDarkMode ? 'bg-[#161B22] border border-[#293038]' : 'bg-[#f0f0f0] border border-[#e0e0e0]'} rounded-xl p-4 mb-4`}>
                ...
                <p className="text-sm text-[#3B82F6]">Universidad de Bellas Artes · 2014 - 2018</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`${isDarkMode ? 'bg-[#161B22] border border-[#293038]' : 'bg-[#f0f0f0] border border-[#e0e0e0]'} rounded-xl p-4 sm:p-6 mb-8`}>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
            <div className="mb-3">
              <h3 className={`${isDarkMode ? 'text-[#3B82F6]' : 'text-[#3B82F6]'} font-bold mb-2 text-sm sm:text-base`}>Lenguajes</h3>
            ...
            <div className="mb-3">
              <h3 className={`${isDarkMode ? 'text-[#3B82F6]' : 'text-[#3B82F6]'} font-bold mb-2 text-sm sm:text-base`}>Frameworks</h3>
              <ul className={`${isDarkMode ? 'text-[#9dabb8]' : 'text-[#666]'} list-disc pl-5 text-xs sm:text-sm space-y-1`}>
                <li>FastAPI</li>
                <li>Django</li>
                <li>Flask</li>
            ...
            <div className="mb-3">
              <h3 className={`${isDarkMode ? 'text-[#3B82F6]' : 'text-[#3B82F6]'} font-bold mb-2 text-sm sm:text-base`}>Bases de Datos</h3>
              <ul className={`${isDarkMode ? 'text-[#9dabb8]' : 'text-[#666]'} list-disc pl-5 text-xs sm:text-sm space-y-1`}>
                <li>PostgreSQL</li>
                <li>MongoDB</li>
                <li>Redis</li>
            ...
            <div className="mb-3">
              <h3 className={`${isDarkMode ? 'text-[#3B82F6]' : 'text-[#3B82F6]'} font-bold mb-2 text-sm sm:text-base`}>DevOps</h3>
              <ul className={`${isDarkMode ? 'text-[#9dabb8]' : 'text-[#666]'} list-disc pl-5 text-xs sm:text-sm space-y-1`}>
                <li>Docker</li>
                <li>Kubernetes</li>
            ...
            <div className="mb-3">
              <h3 className={`${isDarkMode ? 'text-[#3B82F6]' : 'text-[#3B82F6]'} font-bold mb-2 text-sm sm:text-base`}>Herramientas</h3>
              <ul className={`${isDarkMode ? 'text-[#9dabb8]' : 'text-[#666]'} list-disc pl-5 text-xs sm:text-sm space-y-1`}>
                <li>Git</li>
                <li>Postman</li>
                <li>VS Code</li>
            ...
            <div className="mb-3">
              <h3 className={`${isDarkMode ? 'text-[#3B82F6]' : 'text-[#3B82F6]'} font-bold mb-2 text-sm sm:text-base`}>Otros</h3>
              <ul className={`${isDarkMode ? 'text-[#9dabb8]' : 'text-[#666]'} list-disc pl-5 text-xs sm:text-sm space-y-1`}>
                <li>RESTful APIs</li>
                <li>GraphQL</li>
                <li>WebSockets</li>
