      ...
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          {Object.entries(projects).map(([id, project]) => (
            <div key={id} className={`${isDarkMode ? 'bg-[#161B22] border border-[#293038]' : 'bg-[#f0f0f0] border border-[#e0e0e0]'} rounded-xl overflow-hidden transform hover:scale-[1.02] transition-all duration-300 shadow-lg group`}>
              <div 
                className="w-full aspect-video bg-center bg-no-repeat bg-cover border-b border-[#293038]"
